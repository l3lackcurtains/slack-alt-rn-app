...
import {getAllChannels, getChannelsInTeam, getMyChannelMemberships} from 'app/redux/selectors/entities/channels';
import {getCurrentUser, getUsers} from 'app/redux/selectors/entities/users';
import {getConfig} from 'app/redux/selectors/entities/general';
import {getLastPostPerChannel} from 'app/redux/selectors/entities/posts';
import {
    getMyPreferences,
