...
import { replaceScreen, resetToChannel } from 'app/actions/navigation';
...
import { ActivityIndicator, DeviceEventEmitter, Image, Keyboard, KeyboardAvoidingView, Platform, SafeAreaView, StatusBar, StyleSheet, Text, TextInput, TouchableWithoutFeedback, View } from 'react-native';
...
export default class SelectServer extends PureComponent {
    ...
    goToNextScreen = (screen, title, passProps = {}, navOptions = {}) => {
        ...
        replaceScreen(screen, title, passProps, options);
    };
    ...
    handleLoginOptions = (props = this.props) => {
        ...
        if (Platform.OS === 'ios') {
            ...
            setTimeout(() => {
                this.goToNextScreen(screen, title, {}, navOptions);
            }, 350);
        } else {
            this.goToNextScreen(screen, title, {}, navOptions);
        }
